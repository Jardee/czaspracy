<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('work-entries.index')" :active="request()->routeIs('work-entries.index') || request()->routeIs('work-entries.show') || request()->routeIs('work-entries.create') || request()->routeIs('work-entries.edit')">
                {{ __('Wpisy Czasu Pracy') }}
